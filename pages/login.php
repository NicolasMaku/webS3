...
<div class="container">
    <div class="left" id="left">
        <div class="left-content">
            <div class="header">
                <h2 class="animation a1">LOGIN USER</h2>
            ...
            <form action="../controllers/loginControl.php" method="POST" class="form" id="formlog">
                ...
                <p class="animation a5"> <a href="#" style="padding-right: 40%" id="sign-up-btn">Login Admin</a></p>
    ...
    <div class="right" id="right">
        <div class="right-content">
            <div class="header">
                <h2 class="animation-reverse a1">LOGIN ADMIN</h2>
            ...
            <form action="../controllers/loginControl.php" method="POST" class="form" id="formSign">
                <input type="hidden" name="action" value="login">
                <input type="email" class="form-field animation-reverse a4" placeholder="Email Address" name="email" value="john@example.com" required>
                <input type="password" class="form-field animation-reverse a5" placeholder="Password" name="password" value="password123" required>

                <p class="animation-reverse a6"> <a href="#" style="padding-right: 40%" id="login-btn">Login User</a></p>
                <input type="submit"  value="LOGIN" class="button animation-reverse a7">
            </form>
        </div>
    </div>
