<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="row" data-masonry="{&quot;percentPosition&quot;: true }" style="position: relative; height: 856.362px;">
            ...
            <div class="col-sm-6 col-lg-4 mb-4" style="position: absolute; left: 33.3329%; top: 0px;">
                <div class="card p-3">
            ...
            <div class="col-sm-6 col-lg-4 mb-4" style="position: absolute; left: 66.6659%; top: 0px;">
                <div class="card">
                    <img class="card-img-top" src="../assets/img/elements/18.jpg" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
            ...
            <div class="col-sm-6 col-lg-4 mb-4" style="position: absolute; left: 33.3329%; top: 159.125px;">
            ...
            <div class="col-sm-6 col-lg-4 mb-4" style="position: absolute; left: 33.3329%; top: 286.25px;">
                <div class="card text-center">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
            ...
            <div class="col-sm-6 col-lg-4 mb-4" style="position: absolute; left: 33.3329%; top: 476.9px;">
                <div class="card">
                    <img class="card-img-top" src="../assets/img/elements/4.jpg" alt="Card image cap">
                </div>
            </div>
            <div class="col-sm-6 col-lg-4 mb-4" style="position: absolute; left: 0%; top: 530.112px;">
            ...
            <div class="col-sm-6 col-lg-4 mb-4" style="position: absolute; left: 66.6659%; top: 546.112px;">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Card title</h5>
                        <p class="card-text">
